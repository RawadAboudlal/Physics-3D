package com.rawad.phys.fileparser.xml;
...
import com.rawad.phys.entity.Component;
import com.rawad.phys.entity.Entity;
...
public class EntityFileParser extends FileParser {
	...
	public void parseEntityFile(Class<? extends Object> entityFileContext, String entityFileName, 
			String... contextPaths) {
	...
	public static void saveEntityBlueprint(Entity e, String entitySaveFileLocation, String... contextPaths) {
		...
		try {
			...
			components.getComponents().addAll(e.getComponents().getOrderedMap());
